...
function initBuffers(gl) {
    ...
    // Fill the Triangle vertex buffer
	...
	// Fill the texture coordinates buffer for Triangle
	...
	// Fill the Square vertex buffer
	squareVertexBuffer = gl.createBuffer();   
	gl.bindBuffer(gl.ARRAY_BUFFER, squareVertexBuffer);
	// 4/3 aspect ratio for the picture
	vertices = [
		 -.67, -.5,  -0.5,
		  .67, -.5,  -0.5,
		 -.67,  .5,  -0.5,
	...
	// Fill the texture coordinate buffer for the square
