function Frustum()
{
    ...
    this.frontUpperLeft = [ -.36, .36, -.999999, 1 ];
    this.frontLowerLeft = [ -.36, -.36, -.999999, 1];
    this.frontUpperRight = [ .36, .36, -.999999, 1 ];
    this.backUpperLeft = [ -.36, .36, -40, 1 ];
    this.backLowerLeft = [ -.36, -.36, -40, 1 ];
    this.backUpperRight = [ .36, .36, -40, 1 ];
